// Open in Processing IDE — same visuals as sketch.js (p5.js)
...
void draw() {
  ...
  arc(174, 201, 48, 48, PI / 2, PI);
  arc(126, 201, 48, 48, 0, PI / 2);
  arc(174, 249, 48, 48, PI, PI + PI / 2);
  arc(126, 249, 48, 48, PI + PI / 2, 2 * PI);
